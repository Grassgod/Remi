...
export function createEnDict(allowSignup: boolean): LandingDict {
  ...
  hero: {
    ...
    subheading:
      "Multimira is an open-source platform that turns coding agents into real teammates. Assign tasks, track progress, compound skills \u2014 manage your human + agent workforce in one place.",
    cta: "Start free trial",
    downloadDesktop: "Download Desktop",
    talkToSales: "Talk to sales",
    worksWith: "Works with",
    imageAlt: "Multimira board view \u2014 issues managed by humans and agents",
  },
    ...
    runtimes: {
      ...
      cards: [
        ...
        },
        {
          ...
          description:
            "Multimira scans for 12 supported coding tools \u2014 Antigravity, Claude Code, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, and Pi \u2014 and registers a runtime for each one it finds.",
        },
      ],
    },
  },
  ...
  openSource: {
    ...
    description:
      "Multimira is fully open source. Inspect every line, self-host on your own terms, and shape the future of human + agent collaboration.",
    cta: "Star on GitHub",
    highlights: [
      {
        title: "Self-host anywhere",
        description:
          "Run Multimira on your own infrastructure. Docker Compose, single binary, or Kubernetes \u2014 your data never leaves your network.",
      },
      {
  ...
  faq: {
    ...
    items: [
      {
        question: "What coding agents does Multimira support?",
        answer:
          "Multimira supports 12 coding tools out of the box: Antigravity, Claude Code, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, and Pi. The daemon auto-detects whichever CLIs you already have installed and registers a runtime for each one. Since it's open source, you can also add your own backends.",
      },
      {
        question: "Do I need to self-host, or is there a cloud version?",
        answer:
          "Both. You can self-host Multimira on your own infrastructure with Docker Compose or Kubernetes, or use our hosted cloud version. Your data, your choice.",
      },
      {
        question:
          "How is this different from just using coding agents directly?",
        answer:
          "Coding agents are great at executing. Multimira adds the management layer: task queues, team coordination, skill reuse, runtime monitoring, and a unified view of what every agent is doing. Think of it as the project manager for your agents.",
      },
      {
        question: "Can agents work on long-running tasks autonomously?",
        answer:
          "Yes. Multimira manages the full task lifecycle \u2014 enqueue, claim, execute, complete or fail. Agents report blockers proactively and stream progress in real time. You can check in whenever you want or let them run overnight.",
      },
      {
        question: "Is my code safe? Where does agent execution happen?",
        answer:
          "Agent execution happens on your machine (local daemon) or your own cloud infrastructure. Code never passes through Multimira servers. The platform only coordinates task state and broadcasts events.",
      },
      {
  ...
  changelog: {
    title: "Changelog",
    subtitle: "New updates and improvements to Multimira.",
    toc: "All releases",
    categories: {
    ...
    entries: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Multimira now supports Lark as a third-party integration, so teams can scan a QR code and create a Multimira agent as a Lark Bot",
          ...
          "Agents now include built-in Multimira skills so they can follow workspace workflows more consistently",
        ],
        improvements: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Multimira now supports Japanese across the app, site, and docs",
      ...
      },
      {
        ...
        features: [
          ...
          "Multimira now supports Korean across the app, public site, and documentation, including Korean docs pages and localized date formatting",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Projects can now use a local working directory on Desktop, so tasks can run in an existing folder while Multimira shows when another task is waiting for that directory",
      ...
      },
      {
        version: "0.3.8",
        date: "2026-05-25",
        title: "Multimira for iOS, Helm Self-Hosting & Smoother Collaboration",
        changes: [],
        features: [
          "Multimira for iOS is now available as our first official usable mobile client, covering login, workspaces, inbox, Issues, projects, chat, comments, reactions, presence, and live updates; it is not on the App Store yet, so users need to build and install it manually",
          "Self-hosted teams can now deploy Multimira to Kubernetes with a Helm chart, while Docker-based installs keep clearer port and URL controls",
        ...
        fixes: [
          ...
          "Codex runs no longer inherit hidden host memory during Multimira tasks, and Pi runs receive a cleaner end-of-input signal",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "New users now enter a guided welcome experience where Multimira Helper can introduce the workspace, give a tour, or build a slide-style welcome page",
      ...
      },
      {
        ...
        improvements: [
          ...
          "GitHub-linked pull requests now surface CI and merge-conflict status inside Multimira",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Connect GitHub so linked pull requests appear on Multimira issues, sync their status, and close the Multimira issue automatically when the PR closes",
        ...
        improvements: [
          ...
          "Linux desktop packages show the Multimira app icon again",
        ],
        fixes: [
      ...
      },
      {
        ...
        fixes: [
          ...
          "Windows / Linux desktop replaces the Electron placeholder icon with the Multimira asterisk",
      ...
      },
      {
        ...
        improvements: [
          ...
          "Multimira Agent commits include a `Co-authored-by` trailer for proper Git attribution",
  ...
  contactSales: {
    ...
    pageDescription:
      "Talk to the Multimira team about rolling out human + agent workflows at your company.",
    ...
    fields: {
      ...
      useCase: "How do you plan to use or collaborate with Multimira?",
      goals: "Your goals or challenges",
      goalsHint:
        "Tell us what you’d like to achieve with Multimira or the challenges you’re facing. The more details you provide, the better we can support you.",
    ...
    useCases: [
      { value: "evaluate", label: "Evaluating Multimira for my team" },
      { value: "adopt_team", label: "Rolling out Multimira to a team or company" },
      { value: "self_host", label: "Self-hosting on our own infrastructure" },
      { value: "integrate", label: "Integrating Multimira with existing tools" },
    ...
    consent: {
      intro:
        "Multimira, Inc. respects your privacy. We’ll use your personal information only to manage your account and deliver the products or services you’ve requested. Occasionally, we’d love to share product updates, best practices, and insights that may be relevant to you. Please let us know below if you’d like to hear from us.",
      outreach:
        "I’d like to receive one-to-one communication from Multimira, Inc., including service updates, support inquiries, and business-related follow-ups.",
      updates:
        "I’d like to receive product updates, insights, and event invitations from Multimira.",
      unsubscribe:
      ...
      submitConsent:
        "By clicking “Submit,” you consent to allow Multimira, Inc. to store and process your information for the purpose of delivering the requested content.",
    ...
    success: {
      ...
      message:
        "A member of the Multimira team will respond within three business days. In the meantime, feel free to explore the docs or star us on GitHub.",
      cta: "Back to home",
    },
    errors: {
