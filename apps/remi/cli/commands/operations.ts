...
function runtimeSpecs(): CommandSpec[] {
  ...
  return [
    ...
    op({ id: "runtime.model.catalog", path: ["runtime", "model", "catalog"], description: "List model providers for the fleet or an execution target", method: "GET", apiPath: "/api/models", auth: HUMAN, options: [{ name: "runtime", type: "string", valueName: "runtime-id", description: "Filter by execution target" }], query: (i) => queryOptions(i, { runtime_id: stringOption(i, "runtime") }), collections: ["providers"] }),
