...
postgres_db="multimira_${slug}_${offset}"
postgres_port=5432
...
DATABASE_URL=postgres://multimira:multimira@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
MULTIMIRA_DEV_VERIFICATION_CODE=888888
MULTIMIRA_SERVER_URL=ws://localhost:${backend_port}/ws
