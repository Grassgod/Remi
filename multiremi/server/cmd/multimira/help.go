...
var rootHelpTemplate = `Work seamlessly with Multimira from the command line.

USAGE
  multimira <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
EXAMPLES
  ...
  $ multimira agent list --output json

ENVIRONMENT VARIABLES
  MULTIMIRA_SERVER_URL    Override the default server URL
  MULTIMIRA_WORKSPACE_ID  Set the active workspace

LEARN MORE
  Use ` + "`multimira <command> <subcommand> --help`" + ` for more information about a command.
`
