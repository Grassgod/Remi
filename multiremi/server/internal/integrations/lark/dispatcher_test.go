...
func boundUser() db.LarkUserBinding {
	return db.LarkUserBinding{
		ID:             validUUID(0x44),
		WorkspaceID:    validUUID(0x22),
		MultimiraUserID:  validUUID(0x55),
...
func TestDispatcher_PlainMessageEnqueuesTask(t *testing.T) {
	...
	if chat.lastEnsureParams.Sender != queries.userBinding.MultimiraUserID {
...
// invariant: in a Lark group with TWO Multimira bots installed, the
