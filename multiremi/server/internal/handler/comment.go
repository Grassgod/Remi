...
// emitted via the X-Multimira-Next-Before / X-Multimira-Next-Before-Id
// response headers.
//
...
func (h *Handler) ListComments(w http.ResponseWriter, r *http.Request) {
	...
	if result.NextBefore != "" && result.NextBeforeID != "" {
		w.Header().Set("X-Multimira-Next-Before", result.NextBefore)
		w.Header().Set("X-Multimira-Next-Before-Id", result.NextBeforeID)
	}
