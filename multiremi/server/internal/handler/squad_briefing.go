...
2. **Delegate by @mention.** Post a single comment on this issue that
   ...
   - **Be terse.** Every Multimira agent already has full context of the
...
3. **Record your evaluation.** After every trigger — whether you delegated,
   ...
   ` + "`" + `multimira squad activity <issue-id> <outcome> --reason "<short reason>"` + "`" + `
...
- ALWAYS call ` + "`" + `multimira squad activity` + "`" + ` before ending your turn —
