...
func TestRelativeWorkDir(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			workDir:  "/Users/alice/multimira_workspaces/" + wsID + "/5c57b65b/workdir",
			wsID:     wsID,
			taskID:   taskID,
		...
		},
		{
			...
			workDir:  "/Users/alice/multimira_workspaces/" + wsID + "/5c57b65b",
			wsID:     wsID,
			taskID:   taskID,
		...
		},
		{
			...
			workDir:  "/Users/df007df/code/work/projects/multimira/foo",
			wsID:     wsID,
			taskID:   taskID,
			expected: "code/work/projects/multimira/foo",
		},
		{
		...
		},
		{
			...
			workDir:  `C:\Users\alice\multimira_workspaces\` + wsID + `\5c57b65b\workdir`,
			wsID:     wsID,
			taskID:   taskID,
			expected: wsID + "/5c57b65b/workdir",
		},
		{
			...
			wsID:     "",
			taskID:   taskID,
			expected: "multimira_workspaces/" + wsID + "/5c57b65b/workdir",
		},
		{
