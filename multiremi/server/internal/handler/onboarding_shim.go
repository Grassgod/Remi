...
import (
	...
	"github.com/multimira-ai/multimira/server/internal/issueguard"
	...
	"github.com/multimira-ai/multimira/server/pkg/protocol"
)
...
const (
	onboardingAssistantName = "Multimira Helper"
	onboardingIssueTitle    = "Start here: learn Multimira with Multimira Helper"
	onboardingAgentTemplate = "multimira_helper"
...
const onboardingAssistantDescription = "Built-in workspace assistant. Answers Multimira questions and runs CLI operations."
...
// Multimira Helper agent created by this shim. Pre-v3 desktop submits a
...
// is removed.
const onboardingAssistantInstructions = `You are Multimira Helper, the built-in AI assistant for this Multimira workspace. Your role is to help any member use Multimira better — answer questions, give advice, and execute workspace operations on their behalf.
...
const onboardingIssueDescription = `Welcome to Multimira.

This is your guided first run. Multimira Helper is assigned to this issue and will help you try the core workflow:

1. Read Multimira Helper's first comment.
2. Reply with something you want to build, fix, write, or plan.
3. @mention Multimira Helper when you want it to continue.
...
//
// Creates or reuses one "Multimira Helper" agent on the supplied runtime,
...
func enNoRuntimeIssueDescription() string {
	return strings.Join([]string{
		"Welcome to Multimira.",
		"",
		"Agents need a runtime before they can execute work. You can still use Multimira as a lightweight project-management workspace while you install one.",
		"",
		"## Try Multimira first",
		"",
		...
		"",
		"Full guide: https://multimira.ai/docs/install-agent-runtime",
		"",
		...
		"   which codex",
		"   codex --version",
		"5. Restart the Multimira daemon:",
		...
		"",
		"When the runtime is connected, you can create Multimira Helper for a guided first run.",
	}, "\n")
}
...
func zhNoRuntimeIssueDescription() string {
	return strings.Join([]string{
		"欢迎来到 Multimira。",
		"",
		"智能体需要先连上运行时才能执行工作。运行时还没准备好时，你也可以先把 Multimira 当作轻量项目管理工具体验起来。",
		"",
		"## 先体验项目管理功能",
		"",
		"运行时安装前，你可以先做这些事：",
		...
		"## 安装第一个 Agent 运行时",
		"",
		"完整文档：https://multimira.ai/docs/install-agent-runtime",
		"",
		"中文用户建议先装 Kimi CLI：",
		"",
		...
		"",
		"运行时连上后，你就可以创建 Multimira Helper，开始一次有智能体参与的上手引导。",
	}, "\n")
}
