...
- `server/cmd/multimira/cmd_project.go` registers project `list`, `get`, `create`, `update`, `delete`, and `status`.
...
- Project resources are written into `.multimira/project/resources.json` for agent workdirs.
