...
This file records source evidence for `multimira-squads/SKILL.md`.
...
```text
server/cmd/multimira/cmd_squad.go
```
...
multimira squad get <squad-id>
multimira squad create
multimira squad update <squad-id>
multimira squad delete <squad-id>
multimira squad activity <issue-id> <outcome>

multimira squad member list <squad-id>
multimira squad member add <squad-id>
multimira squad member remove <squad-id>
