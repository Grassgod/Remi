...
func TestRealtimeCollectorExposesCounters(t *testing.T) {
	...
	for _, want := range []string{
		"multimira_realtime_active_connections 3",
		"multimira_realtime_messages_sent_total 11",
		"multimira_realtime_redis_connected 1",
		`multimira_realtime_redis_mirror_errors_total{target="primary"} 2`,
		`multimira_realtime_redis_mirror_errors_total{target="secondary"} 5`,
	} {
