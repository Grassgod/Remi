...
RETURNING id, workspace_id, multimira_user_id, installation_id, lark_open_id, union_id, bound_at
`

type CreateLarkUserBindingParams struct {
	WorkspaceID    pgtype.UUID `json:"workspace_id"`
	MultimiraUserID  pgtype.UUID `json:"multimira_user_id"`
	InstallationID pgtype.UUID `json:"installation_id"`
	LarkOpenID     string      `json:"lark_open_id"`
...
SELECT id, workspace_id, multimira_user_id, installation_id, lark_open_id, union_id, bound_at FROM lark_user_binding
