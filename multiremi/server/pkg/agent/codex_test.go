...
func TestEnsureCodexMcpConfigEmptyClearsBlock(t *testing.T) {
	...
	got := string(data)
	if strings.Contains(got, multimiraCodexMcpBeginMarker) {
...
func TestEnsureCodexMcpConfigWritesManagedBlock(t *testing.T) {
	...
	if !strings.Contains(got, multimiraCodexMcpBeginMarker) || !strings.Contains(got, multimiraCodexMcpEndMarker) {
