...
func TestGeminiStaticModelsExposesAliasesAndGemini3(t *testing.T) {
	...
	// for multimira-ai/multimira#1503 — Gemini 3 must be selectable.
...
func TestCodexStaticModelsExposesGPT55(t *testing.T) {
	...
	// hand-maintained. Regression guard for multimira-ai/multimira#2009 —
...
func TestCopilotStaticModelsExposesFullCatalog(t *testing.T) {
	...
	// docs. Regression guard for multimira-ai/multimira#1948 — the
