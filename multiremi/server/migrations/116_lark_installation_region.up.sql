-- Add a per-installation `region` so one Multimira deployment can serve
...
-- deployment-wide value (the MULTIMIRA_LARK_HTTP_BASE_URL /
-- MULTIMIRA_LARK_CALLBACK_BASE_URL env knobs, defaulting to open.feishu.cn),
