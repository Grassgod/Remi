...
// Per the ACP spec, message-chunk updates carry a SINGLE ContentBlock
// (codex-acp and claude-agent-acp both send one object). Some test agents
// send an array; accept both shapes.
...
export interface ToolCallProgressUpdate {
  ...
  toolCallId: string;
  /** Some ACP agents include a raw tool name alongside the display title. */
