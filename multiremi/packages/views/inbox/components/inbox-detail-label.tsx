...
import type { InboxItem, InboxItemType, IssueStatus, IssuePriority } from "@multimira/core/types";
...
// never shifts with the viewer's offset (see @multimira/core/issues/date).
