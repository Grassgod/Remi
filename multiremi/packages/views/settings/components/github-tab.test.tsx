...
vi.mock("@multimira/core/github", async () => {
  const actual =
    await vi.importActual<typeof import("@multimira/core/github")>("@multimira/core/github");
  return {
    ...actual,
...
describe("GitHubTab", () => {
  ...
  it("clicking Disconnect opens the confirmation and only fires on confirm", async () => {
    ...
    expect(screen.getByText(/Multiremi will stop receiving webhooks/i)).toBeTruthy();
