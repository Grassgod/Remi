...
vi.mock("@multimira/core/projects/queries", () => ({
...
vi.mock("@multimira/core/issues/mutations", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@multimira/core/issues/mutations")>();
  return {
    ...actual,
