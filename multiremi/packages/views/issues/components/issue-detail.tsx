...
import { Skeleton } from "@multimira/ui/components/ui/skeleton";
import { Button } from "@multimira/ui/components/ui/button";
import { ResizablePanelGroup, ResizablePanel, ResizableHandle } from "@multimira/ui/components/ui/resizable";
import { Sheet, SheetContent } from "@multimira/ui/components/ui/sheet";
import { useIsMobile } from "@multimira/ui/hooks/use-mobile";
import { ContentEditor, type ContentEditorRef, TitleEditor, useFileDropZone, FileDropOverlay } from "../../editor";
import { FileUploadButton } from "@multimira/ui/components/common/file-upload-button";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
} from "@multimira/ui/components/ui/tooltip";
import { Popover, PopoverTrigger, PopoverContent } from "@multimira/ui/components/ui/popover";
import { Dialog, DialogContent, DialogHeader, DialogTitle } from "@multimira/ui/components/ui/dialog";
import { Checkbox } from "@multimira/ui/components/ui/checkbox";
import { Command, CommandInput, CommandList, CommandEmpty, CommandGroup, CommandItem } from "@multimira/ui/components/ui/command";
import { AvatarGroup, AvatarGroupCount } from "@multimira/ui/components/ui/avatar";
import { ActorAvatar } from "../../common/actor-avatar";
import { PropRow } from "../../common/prop-row";
import type { Attachment, Issue, IssueStatus, IssuePriority, TimelineEntry, UpdateIssueRequest } from "@multimira/core/types";
import { STATUS_CONFIG, PRIORITY_CONFIG } from "@multimira/core/issues/config";
import { formatDateOnly } from "@multimira/core/issues/date";
import { useUpdateIssue } from "@multimira/core/issues/mutations";
...
import { useGitHubSettings } from "@multimira/core/github";
import { useQuery } from "@tanstack/react-query";
import { useAuthStore } from "@multimira/core/auth";
import { useWorkspacePaths } from "@multimira/core/paths";
import { useActorName } from "@multimira/core/workspace/hooks";
import { useWorkspaceId } from "@multimira/core/hooks";
import { useRecentContextStore } from "@multimira/core/chat";
import { issueListOptions, issueDetailOptions, childIssuesOptions, issueUsageOptions, issueAttachmentsOptions } from "@multimira/core/issues/queries";
import { projectDetailOptions } from "@multimira/core/projects/queries";
import { ProjectIcon } from "../../projects/components/project-icon";
import { issueLabelsOptions } from "@multimira/core/labels";
import { memberListOptions, agentListOptions } from "@multimira/core/workspace/queries";
import { useRecentIssuesStore } from "@multimira/core/issues/stores";
import { useIssueSelectionStore } from "@multimira/core/issues/stores/selection-store";
import { BatchActionToolbar } from "./batch-action-toolbar";
import { useIssueTimeline } from "../hooks/use-issue-timeline";
import { useIssueReactions } from "../hooks/use-issue-reactions";
import { useIssueSubscribers } from "../hooks/use-issue-subscribers";
import { ReactionBar } from "@multimira/ui/components/common/reaction-bar";
import { useFileUpload } from "@multimira/core/hooks/use-file-upload";
...
export function IssueDetail({ issueId, onDelete, onDone, defaultSidebarOpen = true, layoutId = "multimira_issue_detail_layout", highlightCommentId }: IssueDetailProps) {
  ...
  useEffect(() => {
    ...
    const flagKey = `multimira_cmdF_warned:${id}`;
