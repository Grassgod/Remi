...
import {
  ...
  skillDetailOptions,
  workspaceKeys,
} from "@multimira/core/workspace/queries";
...
import { Button, buttonVariants } from "@multimira/ui/components/ui/button";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { Textarea } from "@multimira/ui/components/ui/textarea";
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger,
...
import { useSkillPermissions } from "@multimira/core/permissions";
import { CapabilityBanner } from "@multimira/ui/components/common/capability-banner";
