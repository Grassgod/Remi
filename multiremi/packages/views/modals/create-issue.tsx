...
import type { Issue, IssueStatus, IssuePriority, IssueAssigneeType } from "@multimira/core/types";
import {
  DialogContent,
  DialogTitle,
} from "@multimira/ui/components/ui/dialog";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import { Tooltip, TooltipTrigger, TooltipContent, TooltipProvider } from "@multimira/ui/components/ui/tooltip";
import { Button } from "@multimira/ui/components/ui/button";
import { Switch } from "@multimira/ui/components/ui/switch";
...
import { useCurrentWorkspace, useWorkspacePaths } from "@multimira/core/paths";
import { useWorkspaceId } from "@multimira/core/hooks";
import { useIssueDraftStore } from "@multimira/core/issues/stores/draft-store";
import { useCreateModeStore } from "@multimira/core/issues/stores/create-mode-store";
import { useQuickCreateStore } from "@multimira/core/issues/stores/quick-create-store";
import { issueDetailOptions } from "@multimira/core/issues/queries";
import { useCreateIssue, useUpdateIssue } from "@multimira/core/issues/mutations";
...
import { Dialog as DialogRoot } from "@multimira/ui/components/ui/dialog";
