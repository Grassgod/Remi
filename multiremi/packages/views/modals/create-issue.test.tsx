...
vi.mock("@multimira/core/issues/queries", () => ({
...
vi.mock("@multimira/core/issues/stores/draft-store", () => ({
...
vi.mock("@multimira/core/issues/stores/quick-create-store", () => ({
  useQuickCreateStore: (selector?: (state: typeof mockQuickCreateStore) => unknown) =>
    (selector ? selector(mockQuickCreateStore) : mockQuickCreateStore),
}));

vi.mock("@multimira/core/issues/mutations", () => ({
  useCreateIssue: () => ({ mutateAsync: mockCreateIssue }),
  useUpdateIssue: () => ({ mutate: vi.fn() }),
}));

vi.mock("@multimira/core/hooks/use-file-upload", () => ({
...
vi.mock("@multimira/core/api", async () => {
  ...
  const { parseWithFallback } = await vi.importActual<typeof import("@multimira/core/api/schema")>(
    "@multimira/core/api/schema",
  );
  const { DuplicateIssueErrorBodySchema } = await vi.importActual<
    typeof import("@multimira/core/api/schemas")
  >("@multimira/core/api/schemas");
  return {
    api: {},
    ApiError,
    parseWithFallback,
...
vi.mock("@multimira/ui/components/ui/dialog", () => ({
...
vi.mock("@multimira/ui/components/ui/button", () => ({
  Button: ({
    children,
    disabled,
    onClick,
...
vi.mock("@multimira/ui/components/ui/switch", () => ({
  Switch: ({
    checked,
    onCheckedChange,
  }: {
...
vi.mock("@multimira/ui/components/common/file-upload-button", () => ({
...
vi.mock("@multimira/ui/lib/utils", () => ({
