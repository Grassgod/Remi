...
vi.mock("@multimira/core/projects/mutations", () => ({
  useCreateProject: () => ({ mutateAsync: vi.fn() }),
}));

vi.mock("@multimira/core/projects", () => ({
...
vi.mock("@multimira/ui/components/ui/popover", () => ({
...
vi.mock("@multimira/ui/components/common/emoji-picker", () => ({
  EmojiPicker: () => null,
}));
