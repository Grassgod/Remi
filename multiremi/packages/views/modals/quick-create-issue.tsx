...
import { DialogTitle } from "@multimira/ui/components/ui/dialog";
...
import { useCurrentWorkspace } from "@multimira/core/paths";
import { agentListOptions, squadListOptions } from "@multimira/core/workspace/queries";
import { projectListOptions } from "@multimira/core/projects/queries";
import {
  useQuickCreateStore,
  type QuickCreateActorType,
} from "@multimira/core/issues/stores/quick-create-store";
...
} from "@multimira/core/runtimes";
import { useFileUpload } from "@multimira/core/hooks/use-file-upload";
import { formatShortcut, modKey, enterKey } from "@multimira/core/platform";
import type { Agent, Squad } from "@multimira/core/types";
...
import { memberListOptions } from "@multimira/core/workspace/queries";
import {
  ContentEditor,
...
export function AgentCreatePanel({
  ...
  // bundled multimira CLI to be ≥ MIN_QUICK_CREATE_CLI_VERSION; older
