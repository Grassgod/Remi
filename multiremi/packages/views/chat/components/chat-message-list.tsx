...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@multimira/ui/components/ui/collapsible";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
...
import { isTaskMessageTaskId, taskMessagesOptions } from "@multimira/core/chat/queries";
import { Markdown } from "@multimira/views/common/markdown";
import { copyText } from "@multimira/ui/lib/clipboard";
import { AttachmentList } from "../../issues/components/comment-card";
import type { AgentAvailability } from "@multimira/core/agents";
import type { ChatMessage, ChatPendingTask, TaskFailureReason } from "@multimira/core/types";
import type { ChatTimelineItem } from "@multimira/core/chat";
...
function TimelineView({
  ...
  isStreaming?: boolean;
  attachments?: import("@multimira/core/types").Attachment[];
}) {
