...
import { issueKeys, PAGINATED_STATUSES } from "@multimira/core/issues/queries";
import { I18nProvider } from "@multimira/core/i18n/react";
import type { IssueStatus, ListIssuesCache } from "@multimira/core/types";
...
vi.mock("@multimira/core/platform", () => ({
  getCurrentWsId: () => "ws-1",
}));
