...
import { useWelcomeStore } from "@multimira/core/onboarding";
import { paths, useCurrentWorkspace } from "@multimira/core/paths";
import { resolvePublicFileUrl } from "@multimira/core/workspace/avatar-url";
import { issueKeys } from "@multimira/core/issues/queries";
import { workspaceKeys } from "@multimira/core/workspace/queries";
import type { Agent, CreateIssueRequest, Issue } from "@multimira/core/types";
import {
  Dialog,
  DialogContent,
  DialogDescription,
 ...
 *     2. Find-or-create a "Multimira Helper" agent on the picked runtime
