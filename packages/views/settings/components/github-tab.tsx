...
import { memberListOptions, workspaceKeys } from "@multimira/core/workspace/queries";
import {
  deriveGitHubSettings,
  githubInstallationsOptions,
} from "@multimira/core/github";
              ...
              description={
                <p className="text-sm text-muted-foreground">
                  ...
                  <code className="rounded bg-muted px-1 py-0.5 text-xs">
                    {"Co-authored-by: multimira-agent <github@multimira.ai>"}
                  </code>{" "}
