...
import type { GitHubPullRequest } from "@multimira/core/types";
import enCommon from "../../locales/en/common.json";
import enIssues from "../../locales/en/issues.json";

const TEST_RESOURCES = { en: { common: enCommon, issues: enIssues } };

vi.mock("@multimira/core/github/queries", async () => {
  const actual = await vi.importActual<typeof import("@multimira/core/github/queries")>(
    "@multimira/core/github/queries",
  );
  return {
    ...actual,
