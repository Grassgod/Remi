...
// Mock @multimira/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@multimira/core/issues/stores/view-store", () => ({
...
vi.mock("@multimira/core/issues/stores/view-store-context", () => ({
...
vi.mock("@multimira/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@multimira/core/issues/stores/selection-store", () => ({
...
vi.mock("@multimira/core/issues/stores/recent-issues-store", () => ({
