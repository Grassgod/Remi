...
import type { Agent, MemberWithUser, Squad } from "@multimira/core/types";
...
vi.mock("@multimira/ui/components/ui/input", () => ({
  Input: (props: React.InputHTMLAttributes<HTMLInputElement>) => (
    <input {...props} />
  ),
}));

vi.mock("@multimira/ui/components/ui/label", () => ({
