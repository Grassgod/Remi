...
import type { Agent, AgentRuntime, CreateAgentRequest } from "@multimira/core/types";
import {
...
} from "@multimira/core/agents";
import { useAgentsViewStore } from "@multimira/core/agents/stores";
...
import { canAssignAgentToIssue } from "@multimira/core/permissions";
...
import { DataTable } from "@multimira/ui/components/ui/data-table";
    ...
    <PageHeader className="justify-between px-5">
      <div className="flex items-center gap-2">
        ...
        <p className="ml-2 hidden text-xs text-muted-foreground md:block">
          {t(($) => $.page.tagline)}{" "}
          <a
            href="https://multimira.ai/docs/agents"
            target="_blank"
