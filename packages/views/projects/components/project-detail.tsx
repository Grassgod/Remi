...
import type { Issue, IssueAssigneeGroup, ProjectStatus, ProjectPriority, UpdateIssueRequest } from "@multimira/core/types";
import { useAuthStore } from "@multimira/core/auth";
import { projectDetailOptions } from "@multimira/core/projects/queries";
import { useUpdateProject, useDeleteProject } from "@multimira/core/projects/mutations";
import { pinListOptions } from "@multimira/core/pins";
import { useCreatePin, useDeletePin } from "@multimira/core/pins";
import {
  ...
  type IssueSortParam,
  type MyIssuesFilter,
} from "@multimira/core/issues/queries";
import { useUpdateIssue } from "@multimira/core/issues/mutations";
import { useModalStore } from "@multimira/core/modals";
import { memberListOptions, agentListOptions } from "@multimira/core/workspace/queries";
import { agentTaskSnapshotOptions } from "@multimira/core/agents";
...
import { PROJECT_STATUS_ORDER, PROJECT_STATUS_CONFIG, PROJECT_PRIORITY_ORDER } from "@multimira/core/projects/config";
import { BOARD_STATUSES } from "@multimira/core/issues/config";
import { createIssueViewStore } from "@multimira/core/issues/stores/view-store";
import { ViewStoreProvider, useViewStore } from "@multimira/core/issues/stores/view-store-context";
...
import {
  ...
  DropdownMenuTrigger,
} from "@multimira/ui/components/ui/dropdown-menu";
import {
  Popover,
  PopoverTrigger,
  PopoverContent,
} from "@multimira/ui/components/ui/popover";
import {
  Tooltip,
  TooltipTrigger,
  TooltipContent,
} from "@multimira/ui/components/ui/tooltip";
import { EmojiPicker } from "@multimira/ui/components/common/emoji-picker";
...
import {
  ...
  AlertDialogHeader,
  AlertDialogTitle,
} from "@multimira/ui/components/ui/alert-dialog";
