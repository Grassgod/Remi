// Mirrors the multimira-cloud Billing module response shapes
// (multimira-cloud/docs/api/billing.md). These types are the contract our
// frontend consumes via /api/cloud-billing/* — multimira-api itself does
