 ...
 *
 * Uses exact hostname match against `cdnDomain` (e.g. "multimira-static.copilothub.ai"),
 ...
 * @param cdnDomain CDN hostname for legacy link detection (e.g. "multimira-static.copilothub.ai")
 */
