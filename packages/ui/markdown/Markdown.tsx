...
import { CODE_LIGATURE_CLASS } from '@multimira/ui/lib/code-style'
...
export interface MarkdownProps {
  ...
  /**
   * CDN hostname for file card detection (e.g. "multimira-static.copilothub.ai").
...
// and Multimira's internal mention/slash protocols.
...
/**
 * Custom URL transform that allows Multimira internal protocols while keeping
