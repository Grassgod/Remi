...
// Tests for `multimira issue metadata list` 404-degradation behavior, plus
...
// endpoint working.
//
// Background: GitHub issue multimira-ai/multimira#3711 — on self-hosted
// backends that pre-date the per-issue metadata route, agent runtime
// bootstrap calls `multimira issue metadata list <issue> --output json`
