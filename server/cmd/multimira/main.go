...
var rootCmd = &cobra.Command{
	Use:   "multimira",
	Short: "Multimira CLI — local agent runtime and management tool",
	Long:  "Work seamlessly with Multimira from the command line.",
	SilenceUsage:  true,
	SilenceErrors: true,
}
...
func init() {
	...
	rootCmd.SetVersionTemplate("multimira {{.Version}}\n")
	...
	rootCmd.PersistentFlags().String("server-url", "", "Multimira server URL (env: MULTIMIRA_SERVER_URL)")
	rootCmd.PersistentFlags().String("workspace-id", "", "Workspace ID (env: MULTIMIRA_WORKSPACE_ID)")
