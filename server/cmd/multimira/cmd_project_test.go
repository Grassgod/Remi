...
// review round 2: `multimira project resource update <p> <r> --default-branch-hint x`
...
func TestBuildResourceRefFromFlagsGithubMergesHint(t *testing.T) {
	t.Run("hint-only edit preserves existing url", func(t *testing.T) {
		...
		existing := map[string]any{"url": "https://github.com/multimira-ai/multimira"}
	...
	t.Run("hint=empty clears the hint but keeps url", func(t *testing.T) {
		...
		existing := map[string]any{
			"url":                 "https://github.com/multimira-ai/multimira",
	...
	t.Run("url override survives merge", func(t *testing.T) {
		cmd := newProjectResourceUpdateTestCmd()
		_ = cmd.Flags().Set("url", "https://github.com/multimira-ai/new-repo")
		existing := map[string]any{
			"url":                 "https://github.com/multimira-ai/multimira",
		...
		if ref["url"] != "https://github.com/multimira-ai/new-repo" {
