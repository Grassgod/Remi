...
// ([MUL-2946](https://multimira/issues/MUL-2946)). Subsequent PRs use
...
const (
	// Platform / scheduler side: failure attributable to Multimira
	...
	// message. Treated as platform-side because it is a Multimira-imposed
