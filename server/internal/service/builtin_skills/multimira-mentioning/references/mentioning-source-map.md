...
| --- | --- | --- |
| `workspace member list` | `user_id` (NOT the membership-row id) | `server/cmd/multimira/cmd_workspace.go:465` |
| `agent list` | `id` | `server/cmd/multimira/cmd_agent.go:365` |
| `squad list` | `id` | `server/cmd/multimira/cmd_squad.go:57` |
