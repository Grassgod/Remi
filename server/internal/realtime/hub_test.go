...
func TestCheckOrigin(t *testing.T) {
	...
	cases := []struct {
		...
		{"empty origin allowed", "api.multimira.ai", "", true},
		{"same-origin allowed (native client default)", "localhost:8080", "http://localhost:8080", true},
		{"same-origin allowed (https)", "api.multimira.ai", "https://api.multimira.ai", true},
		{"same-origin allowed (case-insensitive host, RFC 7230)", "API.Multimira.AI", "https://api.multimira.ai", true},
		{"whitelisted origin allowed (web cross-origin)", "localhost:8080", "http://localhost:3000", true},
		{"whitelisted origin allowed (prod web)", "api.multimira.ai", "https://multimira.ai", true},
		{"unknown origin rejected (CSWSH defense)", "api.multimira.ai", "https://evil.com", false},
