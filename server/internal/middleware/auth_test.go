...
func TestAuth_ValidToken(t *testing.T) {
	...
	if gotEmail != "test@multimira.ai" {
		t.Fatalf("expected X-User-Email 'test@multimira.ai', got '%s'", gotEmail)
	}
}
...
// as the daemon side: with no MULTIMIRA_CLOUD_FLEET_URL configured, an
