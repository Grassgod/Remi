...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.multimira.ai"
	cookieDomain string // cookie scope, e.g. ".multimira.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.multimira.ai")
//   - COOKIE_DOMAIN           (e.g. ".multimira.ai")
