...
// (Multimira Cloud Node) PAT. Tokens with this prefix are validated by
// calling the Multimira Cloud Fleet service rather than by hitting our
...
// MULTIMIRA_CLOUD_FLEET_URL configured simply rejects mcn_ tokens at
...
type CloudPATVerifierConfig struct {
	...
	// https://fleet.multimira.cloud). Trailing slashes are trimmed.
