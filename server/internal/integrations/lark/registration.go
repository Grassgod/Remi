...
//     and an expiry. Multimira renders the QR, the user scans it in the
...
type RegistrationConfig struct {
	...
	// telemetry can attribute installs back to Multimira. Empty defaults
	// to "multimira".
	Source string
...
type BeginResult struct {
	DeviceCode string
	// QRCodeURL is the verification_uri_complete with Multimira's `source`
...
// "<agent> - Multimira" instead of Lark's auto-generated
...
// cannot attribute installs back to Multimira in their analytics.
//
