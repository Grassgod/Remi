 ...
 * The UI wiring is covered by `chat-input.test.tsx` in @multiremi/views; this
...
const DATABASE_URL =
  process.env.DATABASE_URL ?? "postgres://multimira:multimira@localhost:5432/multimira?sslmode=disable";
