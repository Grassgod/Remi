...
MULTIMIRA_APP_URL="${MULTIMIRA_APP_URL:-${FRONTEND_ORIGIN}}"
GOOGLE_REDIRECT_URI="${GOOGLE_REDIRECT_URI:-${FRONTEND_ORIGIN}/auth/callback}"
MULTIMIRA_SERVER_URL="${MULTIMIRA_SERVER_URL:-ws://localhost:${PORT}/ws}"
...
export MULTIMIRA_APP_URL GOOGLE_REDIRECT_URI MULTIMIRA_SERVER_URL LOCAL_UPLOAD_BASE_URL
