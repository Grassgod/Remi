...
import type { Agent, UpdateAgentRequest } from "@multiremi/core/types";
import {
...
import { useAgentPermissions } from "@multiremi/core/permissions";
    ...
    <div className="flex flex-1 min-h-0 flex-col">
      ...
      <div className="flex flex-1 min-h-0 flex-col gap-3 overflow-y-auto p-3 md:grid md:grid-cols-[320px_minmax(0,1fr)] md:gap-4 md:overflow-hidden md:p-6">
        ...
        <AgentOverviewPane
          ...
          runtimes={runtimes}
          onUpdate={handleUpdate}
          canEdit={canEdit.allowed && !agent.archived_at}
