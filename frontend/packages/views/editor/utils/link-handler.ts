...
import { isGlobalPath } from "@multiremi/core/paths";
...
/**
 * Open a link — internal paths dispatch multimira:navigate, external open new tab.
 *
...
export function openLink(href: string, currentSlug?: string | null): void {
  if (href.startsWith("/")) {
    ...
    window.dispatchEvent(
      new CustomEvent("multimira:navigate", { detail: { path } }),
    );
  } else {
