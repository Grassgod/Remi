...
import { useCreateWorkspace } from "@multiremi/core/workspace/mutations";
...
import { isReservedSlug } from "@multiremi/core/paths";
 ...
 * rendered as a `<host>/[slug]` pill, and a live `Issues will look
...
// The workspace URL prefix shown in the slug pills. Use the instance's own
// host instead of a hardcoded brand domain — self-hosted instances aren't
// served from multimira.ai. Resolved in an effect since `window` is
// unavailable during SSR.
function useHostPrefix(): string {
...
export function StepWorkspace({
  ...
  const hostPrefix = useHostPrefix();
