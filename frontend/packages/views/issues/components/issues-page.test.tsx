...
// Mock @multiremi/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@multiremi/core/issues/stores/selection-store", () => ({
...
vi.mock("@multiremi/core/issues/stores/recent-issues-store", () => ({
