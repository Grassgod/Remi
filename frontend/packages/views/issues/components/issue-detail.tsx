...
import { Command, CommandInput, CommandList, CommandEmpty, CommandGroup, CommandItem } from "@multiremi/ui/components/ui/command";
import { AvatarGroup, AvatarGroupCount } from "@multiremi/ui/components/ui/avatar";
import { ActorAvatar } from "../../common/actor-avatar";
import { PropRow } from "../../common/prop-row";
import type { Attachment, Issue, IssueStatus, IssuePriority, TimelineEntry, UpdateIssueRequest } from "@multiremi/core/types";
...
export function IssueDetail({
  ...
  const detailContent = (
    <div className="flex h-full min-w-0 flex-1 flex-col">
        ...
        {/* Session rail + scrollable content, side by side at panel level.
