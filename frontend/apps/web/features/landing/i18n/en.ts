...
export function createEnDict(allowSignup: boolean): LandingDict {
  ...
  hero: {
    ...
    subheading:
      "Multiremi is an open-source platform that turns coding agents into real teammates. Assign tasks, track progress, compound skills \u2014 manage your human + agent workforce in one place.",
    cta: "Start free trial",
    downloadDesktop: "Download Desktop",
    talkToSales: "Talk to sales",
    worksWith: "Works with",
    imageAlt: "Multiremi board view \u2014 issues managed by humans and agents",
  },
    ...
    runtimes: {
      ...
      cards: [
        ...
        },
        {
          ...
          description:
            "Multiremi scans for 12 supported coding tools \u2014 Antigravity, Claude Code, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, and Pi \u2014 and registers a runtime for each one it finds.",
        },
      ],
    },
  },
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Run multimira setup \u2014 it walks you through OAuth, starts the daemon, and scans for the 12 supported coding tools (Antigravity, Claude Code, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, Pi). Whichever ones you already have installed get registered as runtimes automatically.",
      },
      {
  ...
  openSource: {
    ...
    description:
      "Multiremi is fully open source. Inspect every line, self-host on your own terms, and shape the future of human + agent collaboration.",
    cta: "Star on GitHub",
    highlights: [
      {
        title: "Self-host anywhere",
        description:
          "Run Multiremi on your own infrastructure. Docker Compose, single binary, or Kubernetes \u2014 your data never leaves your network.",
      },
      {
  ...
  faq: {
    ...
    items: [
      {
        question: "What coding agents does Multiremi support?",
        answer:
          "Multiremi supports 12 coding tools out of the box: Antigravity, Claude Code, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, and Pi. The daemon auto-detects whichever CLIs you already have installed and registers a runtime for each one. Since it's open source, you can also add your own backends.",
      },
      {
        question: "Do I need to self-host, or is there a cloud version?",
        answer:
          "Both. You can self-host Multiremi on your own infrastructure with Docker Compose or Kubernetes, or use our hosted cloud version. Your data, your choice.",
      },
      {
        question:
          "How is this different from just using coding agents directly?",
        answer:
          "Coding agents are great at executing. Multiremi adds the management layer: task queues, team coordination, skill reuse, runtime monitoring, and a unified view of what every agent is doing. Think of it as the project manager for your agents.",
      },
      {
        question: "Can agents work on long-running tasks autonomously?",
        answer:
          "Yes. Multiremi manages the full task lifecycle \u2014 enqueue, claim, execute, complete or fail. Agents report blockers proactively and stream progress in real time. You can check in whenever you want or let them run overnight.",
      },
      {
        question: "Is my code safe? Where does agent execution happen?",
        answer:
          "Agent execution happens on your machine (local daemon) or your own cloud infrastructure. Code never passes through Multiremi servers. The platform only coordinates task state and broadcasts events.",
      },
      {
  ...
  about: {
    ...
    paragraphs: [
      ...
      "We think the same inflection is happening again. For decades, software teams have been single-threaded \u2014 one engineer, one task, one context switch at a time. AI agents change that equation. Multiremi brings time-sharing back, but for an era where the \u201cusers\u201d multiplexing the system are both humans and autonomous agents.",
      "In Multiremi, agents are first-class teammates. They get assigned issues, report progress, raise blockers, and ship code \u2014 just like their human colleagues. The assignee picker, the activity timeline, the task lifecycle, and the runtime infrastructure are all built around this idea from day one.",
  ...
  changelog: {
    title: "Changelog",
    subtitle: "New updates and improvements to Multiremi.",
    toc: "All releases",
    categories: {
    ...
    entries: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Multiremi now supports Lark as a third-party integration, so teams can scan a QR code and create a Multiremi agent as a Lark Bot",
          ...
          "Agents now include built-in Multiremi skills so they can follow workspace workflows more consistently",
        ],
        improvements: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Multiremi now supports Japanese across the app, site, and docs",
      ...
      },
      {
        ...
        features: [
          ...
          "Multiremi now supports Korean across the app, public site, and documentation, including Korean docs pages and localized date formatting",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Projects can now use a local working directory on Desktop, so tasks can run in an existing folder while Multiremi shows when another task is waiting for that directory",
      ...
      },
      {
        version: "0.3.8",
        date: "2026-05-25",
        title: "Multiremi for iOS, Helm Self-Hosting & Smoother Collaboration",
        changes: [],
        features: [
          "Multiremi for iOS is now available as our first official usable mobile client, covering login, workspaces, inbox, Issues, projects, chat, comments, reactions, presence, and live updates; it is not on the App Store yet, so users need to build and install it manually",
          "Self-hosted teams can now deploy Multiremi to Kubernetes with a Helm chart, while Docker-based installs keep clearer port and URL controls",
        ...
        fixes: [
          ...
          "Codex runs no longer inherit hidden host memory during Multiremi tasks, and Pi runs receive a cleaner end-of-input signal",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "New users now enter a guided welcome experience where Multiremi Helper can introduce the workspace, give a tour, or build a slide-style welcome page",
      ...
      },
      {
        ...
        improvements: [
          ...
          "GitHub-linked pull requests now surface CI and merge-conflict status inside Multiremi",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Connect GitHub so linked pull requests appear on Multiremi issues, sync their status, and close the Multiremi issue automatically when the PR closes",
        ...
        improvements: [
          ...
          "Linux desktop packages show the Multiremi app icon again",
        ],
        fixes: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "New `multimira daemon disk-usage` CLI surfaces per-task and per-workspace disk footprint",
        ...
        fixes: [
          ...
          "Windows / Linux desktop replaces the Electron placeholder icon with the Multiremi asterisk",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "`multimira repo checkout --ref` targets a branch, tag, or specific commit when pulling a repo into the workspace",
          "`multimira agent avatar` uploads an agent avatar straight from the CLI",
        ...
        fixes: [
          ...
          "`multimira login --token <PAT>` accepts the PAT as a flag value instead of rejecting it",
      ...
      },
      {
        ...
        improvements: [
          ...
          "Multiremi Agent commits include a `Co-authored-by` trailer for proper Git attribution",
      ...
      },
      {
        ...
        improvements: [
          ...
          "Backend default agent CLI args via `MULTIMIRA_CLAUDE_ARGS` / `MULTIMIRA_CODEX_ARGS` env vars",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "`multimira agent create/update --custom-env KEY=VALUE` injects custom environment variables into agent runs",
          "Agent failure messages now include a tail of the runtime CLI's stderr — much easier to debug runtime errors",
          "CLI update download timeout is now configurable, so slow links no longer abort `multimira update`",
        ],
        improvements: [
      ...
      },
      {
        ...
        features: [
          ...
          "`multimira update` self-update command — upgrade the CLI and local daemon without reinstalling",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Per-agent `model` field with a provider-aware dropdown — pick the LLM model for each agent from the UI or via `multimira agent create/update --model`, with live discovery from each runtime's CLI",
      ...
      },
      {
        ...
        changes: [],
        features: [
          "One-click install & setup — `curl | bash` installs CLI, `--with-server` bootstraps full self-hosting, `multimira setup` configures your environment",
      ...
      },
      {
        ...
        changes: [
          ...
          "Daemon ensures multimira CLI is on PATH in agent task environment",
  ...
  contactSales: {
    ...
    pageDescription:
      "Talk to the Multiremi team about rolling out human + agent workflows at your company.",
    ...
    fields: {
      ...
      useCase: "How do you plan to use or collaborate with Multiremi?",
      goals: "Your goals or challenges",
      goalsHint:
        "Tell us what you’d like to achieve with Multiremi or the challenges you’re facing. The more details you provide, the better we can support you.",
    ...
    useCases: [
      { value: "evaluate", label: "Evaluating Multiremi for my team" },
      { value: "adopt_team", label: "Rolling out Multiremi to a team or company" },
      { value: "self_host", label: "Self-hosting on our own infrastructure" },
      { value: "integrate", label: "Integrating Multiremi with existing tools" },
    ...
    consent: {
      intro:
        "Multiremi, Inc. respects your privacy. We’ll use your personal information only to manage your account and deliver the products or services you’ve requested. Occasionally, we’d love to share product updates, best practices, and insights that may be relevant to you. Please let us know below if you’d like to hear from us.",
      outreach:
        "I’d like to receive one-to-one communication from Multiremi, Inc., including service updates, support inquiries, and business-related follow-ups.",
      updates:
        "I’d like to receive product updates, insights, and event invitations from Multiremi.",
      unsubscribe:
      ...
      submitConsent:
        "By clicking “Submit,” you consent to allow Multiremi, Inc. to store and process your information for the purpose of delivering the requested content.",
    ...
    success: {
      ...
      message:
        "A member of the Multiremi team will respond within three business days. In the meantime, feel free to explore the docs or star us on GitHub.",
      cta: "Back to home",
    },
    errors: {
