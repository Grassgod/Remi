  ...
  upsert(input: GroupConfigInput): void {
    ...
    this.db.run(
      `INSERT INTO group_configs
        (chat_id, project_id, name, monitor, reply_mode, system_prompt, allowed_tools, allowed_mcps, add_dirs, provider, cwd, launch_command, inject_chat_context, created_at, updated_at)
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
