...
import type { AskUserQuestion } from "../base.js";
import type {
...
function optionFromEnumEntry(entry: { const: string; title?: string }): AskUserQuestion["options"][number] {
...
export function elicitationToQuestions(params: ElicitationCreateParams): ElicitationQuestion[] | null {
  ...
  return fields.map(([fieldKey, prop], index) => {
